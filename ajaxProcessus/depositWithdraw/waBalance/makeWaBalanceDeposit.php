...
if (input::exists("post") && $_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest' && isset($_SERVER['HTTP_REFERER']) && ($_SERVER['HTTP_REFERER'] == "https://koreagaming.info/pages/infos/deposit_withdraw/wa_balance_transaction.php" || $_SERVER['HTTP_REFERER'] == "https://koreagaming.info/pages/member/member_management/partners_list.php")) {
