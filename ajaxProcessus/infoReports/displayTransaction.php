...
if (input::exists("post") && $_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest' && isset($_SERVER['HTTP_REFERER']) && $_SERVER['HTTP_REFERER'] == "https://koreagaming.live/pages/infos/reports/transaction_history.php") {
    ...
    if (token::check(input::get("token"), "display_transaction")) {
        ...
        if ($tableBody == '') {
            $tableBody = '<tr> <td class="text-center" colspan="13">No Records Found!</td> </tr>';
        }
