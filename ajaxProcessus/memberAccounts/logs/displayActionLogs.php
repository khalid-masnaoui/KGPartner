...
if (input::exists("post") && $_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest' && isset($_SERVER['HTTP_REFERER']) && $_SERVER['HTTP_REFERER'] == "https://koreagaming.info/pages/member/accounts/action_logs.php") {
    ...
    if (token::check(input::get("token"), "display_logs")) {
        ...
        if ($tableBody == '') {
            $tableBody = '<tr> <td class="text-center" colspan="8">기록을 찾을 수 없음!</td> </tr>';
        }
