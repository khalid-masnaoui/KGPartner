...
if (input::exists("post") && $_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest' && isset($_SERVER['HTTP_REFERER']) && $_SERVER['HTTP_REFERER'] == "https://koreagaming.info/pages/infos/commissions/partners_commissions.php") {
    ...
    if (token::check(input::get("token"), "display_commissions")) {
        ...
        if ($tableBody == '') {
            $tableBody = '<tr> <td class="text-center" colspan="5">데이터 없음!</td> </tr>';
        } else {
