    ...
    <div class="modal-dialog modal-confirm">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-center">
                <button type="button" class="btn btn-secondary cancel" data-dismiss="delete_modal">Cancel</button>

                <button type="button" class="btn btn-danger btn_confirmed_action delete" data-id=''
                    onclick=deleteClient(event)>Delete</button>
