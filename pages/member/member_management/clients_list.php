...
<div class="position-relative row form-group">
    <label style="font-weight:bold" for="activated_products" class="col-sm-2 col-form-label">Activated Products
    ...
    <input name="allProducts" type="checkbox" value="2" class="d-none" checked><div class="ml-2 mb-2 mr-2 badge badge-pill badge-focus" style="color:white !important;margin-bottom: 0px !important;">All</div></label>
    </label>
    <div class="col-sm-10">
        <section>	
