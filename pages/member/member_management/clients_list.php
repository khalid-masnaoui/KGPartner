...
<div class="position-relative row form-group end_point"><label for="end_point" class="col-sm-2 col-form-label">콜백 URL</label>
...
<div class="position-relative row form-group skinSelect"><label style="font-weight:bold" for="skinSelect" class="col-sm-2 col-form-label">에볼루션 스킨 선택</label>
    <div class="col-sm-10">
        <select type="select" id="skinSelect" name="skinSelect"
            class="custom-select">
            <option value="1" selected = "selected">1 [5,000,000₩]</option>
            <option value="2">2 [3,000,000₩]</option>
            <option value="3">3 [10,000,000₩]</option>
            <option value="4">4 [20,000,000₩]</option>
        </select>
        <div class="invalid-feedback"></div>
    </div>
</div>

<div class="position-relative row form-group d-none skinSelectDG"><label style="font-weight:bold" for="skinSelectDG" class="col-sm-2 col-form-label">드림게이밍 스킨 선택</label>
    <div class="col-sm-10">
        ...
        var constraints = {
            ...
            end_point: {
                ...
                length: {
                    minimum: 1,
                    maximum: 100,
                    message: "^콜백 URL는 필수 항목이며 1~100자를 입력하세요. ",
                },
                url: {
                    allowDataUrl: false,
