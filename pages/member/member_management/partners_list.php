...
<body>
    ...
    <script>
        ...
        function hideEditableInputsAndShow() {
            ...
            $("#exampleModalLongTitle").text("Add Partner");
        ...
        function showEditableInputsAndHide() {
            ...
            $("#exampleModalLongTitle").text("Edit Partner's Rate");
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (response == 1) { //added
                            ...
                            vt.success(`You successfully added a new Partner : ${username}.`, {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (response == 1) { //updated
                            ...
                            vt.success(`You successfully updated the Partner : ${username}.`, {
