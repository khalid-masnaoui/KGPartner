                        ...
                        <div class="mb-3 card" style='height: 93%;'>
                            ...
                            <div class="card-body"
                                ...
                                <div class="tab-content" style="width: 100%;">
                                    ...
                                    <canvas id="turnOverChart" width="400" height="400" style="width: 100%;"></canvas>
                        ...
                        <div class="mb-3 card" style='height: 93%;'>
                            ...
                            <div class="card-body"
                                ...
                                <div class="tab-content" style="width: 100%;">
                                    ...
                                    <canvas id="winLossChart" width="400" height="400" style="width: 100%;"></canvas>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="mb-3 card" style='height: 93%;'>
                            ...
                            <div class="card-body" style='display: flex;justify-content: left;align-items: flex-start;'>
