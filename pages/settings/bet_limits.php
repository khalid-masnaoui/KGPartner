...
$games = $db->get("game_code, game_name_kr", "games_list", [["product_id", "=", 1]])->results();
$gamesOptions = "";
...
<?php
$modal_title = '최대베팅금 설정';
$modal_body = '<form class="">


<div class="position-relative row form-group clientModalSelect"><label for="clientModalSelect" class="col-sm-2 col-form-label">고객사</label>
    <div class="col-sm-10">
...
<div class="position-relative row form-group providerModalSelect"><label style="font-weight:bold" for="providerModalSelect" class="col-sm-2 col-form-label">게임사</label>
    <div class="col-sm-10">
        <select
...
<div class="position-relative row form-group gameModalSelect"><label style="font-weight:bold" for="gameModalSelect" class="col-sm-2 col-form-label">테이블</label>
    <div class="col-sm-10">
...
<div class="position-relative row form-group"><label for="limitAmount" id="depositLabel" class="col-sm-2 col-form-label">최대베팅금(원)</label>
...
<div class="position-relative row form-check">
    <div class="col-sm-10 text-center text-sm-left">
        <button class="btn btn-secondary" id="add_limit" onclick="addBetLimit(event)">저장</button>
    </div>
    <div class="col-sm-10 text-center text-sm-left">
        <button class="btn btn-secondary" id="edit_limit" onclick="editBetLimit(event)">저장</button>
    </div>
</div>
...
<body>
        ...
        <div class="app-main" style="display:block;">
            ...
            <div class="app-main__outer">
                <div class="app-main__inner">
                    ...
                    <?php includeWithVariables('./../../includes/partials/_innerheader.php', array('title' => 'API 정보', 'title_text' => '최대베팅금 제한.', 'icon' => "photo-gallery")); ?>
                                    ...
                                    <div class="d-flex filter-wrapper">
                                        <div class="row mt-2 row_filter_wrapper mb-3">
                                            ...
                                            <div
                                                class="select-status input-group  d-flex pl-0 pr-0 col-md-5 col-lg-4 col-xl-3 col-10 mt-2 pl-0 pr-0 ml-4">
                                                <div class="input-group-prepend"><span
                                                        class="input-group-text">테이블</span></div> <select type="select"
                                                    id="gameSelect" name="gameSelect" class="custom-select">
                                                    <option value='all'>전체</option>
                                                    <?php
                                                    echo $gamesOptions;
                                            ...
                                            <button
                                                class="btn btn-primary filter_limits filter_btn mt-2 ml-4 mr-4">검색</button>
                                    ...
                                    <div class="card-header  card-header2"
                                        ...
                                        <span>
                                            ...
                                            <button class="mb-0 ml-2 btn btn-success betLimitBtn" data-toggle="modal"
                                                data-target=".add_limit" onclick=hideEditeableInputsAndShow()>최대베팅금
                                                설정<span class="badge badge-pill badge-light"> <img
                                        ...
                                        <table
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center">최대베팅금</th>
                                                    <th class="text-center">설정인</th>
                                                    <th class="text-center">설정일시</th>
    ...
    function hideEditeableInputsAndShow() {
        ...
        $("#exampleModalLongTitle").text("최대베팅금 설정");
    }
    ...
    function showEditeableInputsAndHide() {
        ...
        $("#exampleModalLongTitle").text("최대베팅금 수정");
