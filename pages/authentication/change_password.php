        ...
        <div class="app-main">
            ...
            <div class="app-main__outer">
                <div class="app-main__inner">
                    ...
                    <?php includeWithVariables('./../../includes/partials/_innerheader.php', array('title' => 'Password Management', 'title_text' => 'Change Password', 'icon' => "safe")); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="main-card mb-3 card">
                                    <div class="card-header" style='height: 2.5rem;'>Change Password
