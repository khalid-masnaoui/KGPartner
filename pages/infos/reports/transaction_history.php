...
<body>
    ...
    function showBetDetails(transactionId, type, prefix) {
        ...
        popItUp(`https://koreagaming.info/pages/betDetails/betDetails${betDetailsType}.php?transactionId=${transactionId}&prefix=${prefix}`,
            "betDetails");
    }
