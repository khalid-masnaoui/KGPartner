...
<body>
        ...
        <div class="app-main">
            ...
            <div class="app-main__outer">
                <div class="app-main__inner">
                    ...
                    <?php includeWithVariables('./../../../includes/partials/_innerheader.php', array('title' => '포인트관리', 'title_text' => '포인트 이동 내역', 'icon' => "wallet")); ?>
                                ...
                                <div class="main-card mb-3 card">
                                    ...
                                    <div class="btn_read ml-3">
                                        <button class="mb-2 mt-2 ml-2 btn btn-light active" data-toggle="modal"
                                            data-target=".add_deposit" onclick=hideEditableInputsAndShow()>포인트 지급 <span
                                        ...
                                        <input type="hidden" name="token_display" id="token_display"
                                            value="<?= token::generate("display_deposits") ?>">

                                        <input type="hidden" name="token_delete" id="token_delete"
                                            value="<?= token::generate("delete_deposit") ?>">
                                        ...
                                        <input type="hidden" name="token_edit" id="token_edit"
                                            value="<?= token::generate("edit_deposit") ?>">
                                    </div>
    ...
    <script>
        ...
        function displayDeposits(N = 1) {
            ...
            $.ajax({
                url: '/ajaxProcessus/depositWithdraw/displayDeposits.php',
                type: 'POST',
                data: {
                    "display": true,
                    "page": N,
        ...
        function deleteDeposit(event) {
            ...
            $.ajax({
                url: '/ajaxProcessus/depositWithdraw/deleteDeposit.php',
                type: 'POST',
                data: {
                    id,
                    token
                ...
                success: function (data) {
                    ...
                    if (data == 1) {
                        ...
                        vt.success(`You successfully removed the Clients Deposit.`, {
        ...
        function showDepositData(event) {
            ...
            // $("#clientSelectAdd").val(data["client_id"]);
            $("#clientSelectAdd").select2().select2('val', data["client_id"]);
        ...
        function editDeposit(event) {
            ...
            if (typeof errors != undefined && errors != undefined) {
                ...
                $.ajax({
                    url: '/ajaxProcessus/depositWithdraw/editDeposit.php',
                    type: 'POST',
                    data: {
                        depositAmount,
                        depositId,
                    ...
                    success: function (data) {
                        ...
                        if (response == 1) { //updated
                            ...
                            vt.success(`You successfully updated the client's Deposit : ${username}.`, {
