...
<body>
                                ...
                                <div class="main-card mb-3 card">
                                    ...
                                    <div class="row mt-2 row_filter_wrapper mb-3">
                                        ...
                                        <div class="buttons-wrapper">
                                            <button
                                                class="btn btn-primary filter_btn mt-2 filter_commissions mt-xl-0">Submit</button>

                                            <button
                                                class="btn btn-secondary filter_btn filter_commissions_reset mt-2 mt-xl-0">Reset</button>
                                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    ...
                                    <input type="hidden" name="token_display" id="token_display"
                                        value="<?= token::generate("display_commissions") ?>">
    ...
    <script>
        ...
        function displayCommissions(N = 1) {
            ...
            $.ajax({
                url: '/ajaxProcessus/commissions/displayPartnersCommissions.php',
                type: 'POST',
                data: {
                    "display": true,
                    "page": N,
        ...
        //FILTERs
        $(".filter_commissions").on("click", function (event) {
            displayCommissions();
        })

        //RESET FILTERS
        $(".filter_commissions_reset").on("click", function (event) {

            //partner
            $("#partnerSelect").val("all")
